package com.none.sharding.infrastruc.aop;
...
public class MultiDataSourceAspect {
     ...
     * ds0
     */
    @Pointcut("execution(* com.none.sharding.infrastruc.persistence..*.*(..))")
     ...
     * ds1库切入点
     */
    @Pointcut("execution(* com.none.sharding.infrastruc.persistenceOld..*.*(..))")
